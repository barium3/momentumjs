...
const char* BootstrapFoundationScript() {
  return kBootstrapFoundationScript;
}

const char* BootstrapP5CompatScript() {
  return kBootstrapP5CompatScript;
}

const char* BootstrapStateCaptureScript() {
  return kBootstrapStateCaptureScript;
}
