...
- [Shapes](shapes.md)
  `ellipse`, `circle`, `rect`, `square`, `line`, `point`, `triangle`, `quad`, `arc`, `bezier`, `curve`, `ellipseMode`, `rectMode`, `beginShape`, `vertex`, `bezierVertex`, `quadraticVertex`, `curveVertex`, `beginContour`, `endContour`, `endShape`, `clip`, `beginClip`, `endClip`
- [Transform](transform.md)
  `translate`, `rotate`, `scale`, `applyMatrix`, `shearX`, `shearY`, `push`, `pop`, `resetMatrix`
- [Color](color.md)
  `background`, `clear`, `fill`, `noFill`, `stroke`, `noStroke`, `strokeWeight`, `strokeCap`, `strokeJoin`, `blendMode`, `erase`, `noErase`, `color`, `lerpColor`, `colorMode`, `red`, `green`, `blue`, `alpha`, `hue`, `saturation`, `brightness`, `lightness`, `Color.setRed`, `Color.setGreen`, `Color.setBlue`, `Color.setAlpha`, `Color.toString`
...
- [Image](image.md)
  `loadImage`, `image`, `imageMode`, `tint`, `noTint`, `createGraphics`, `createImage`, canvas pixels, Image methods, and Graphics methods
- [Data](data.md)
...
- [Math](math.md)
  Math functions, constants, `createVector`, and Vector instance methods
